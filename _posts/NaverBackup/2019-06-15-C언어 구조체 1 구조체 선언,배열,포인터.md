...
categories:
 - C
naver_url: https://blog.naver.com/rage147-owo/221562816897
---
...
<<<<<<< HEAD:_posts/NaverBackup/2019-6-15-C언어 구조체 1 구조체 선언,배열,포인터.md
​

포인터의 접근으로 사용하는 구조체는 
=======
포인터의 접근으로 사용하는 구조체는
>>>>>>> 9e32db15 (네이버 블로그 동기화 2026-08-07 06:59 — 글 272개):_posts/NaverBackup/2019-06-15-C언어 구조체 1 구조체 선언,배열,포인터.md
