...
categories:
 - C
naver_url: https://blog.naver.com/rage147-owo/221668154242
---
#C++ 2.클래스와 객체 : 네이버 블로그
...
<<<<<<< HEAD:_posts/NaverBackup/2019-10-4-C++ 2.클래스와 객체.md
​
...
=======
접근 지정을 하지 않고 맴버를 선언한 경우 private로 처리된다
>>>>>>> 9e32db15 (네이버 블로그 동기화 2026-08-07 06:59 — 글 272개):_posts/NaverBackup/2019-10-04-C++ 2.클래스와 객체.md
