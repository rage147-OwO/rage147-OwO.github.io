...
categories:
 - C
naver_url: https://blog.naver.com/rage147-owo/221730418607
---
#C++ 14.추상 클래스 : 네이버 블로그
...
<<<<<<< HEAD:_posts/NaverBackup/2019-12-8-C++ 14.추상 클래스.md
​
...
=======
추상 클래스를 사용해 설계과 구현을 나눠 사용 할 수 있다
>>>>>>> 9e32db15 (네이버 블로그 동기화 2026-08-07 06:59 — 글 272개):_posts/NaverBackup/2019-12-08-C++ 14.추상 클래스.md
